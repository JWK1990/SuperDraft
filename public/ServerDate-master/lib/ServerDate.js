...
// This was initially 25 ms, but I've set it to 1,000,000 so that it is changed immediately.
// I also could've opted to decreased the amortizationThreshold below to 10 milliseconds but the docs said to adjust the amortizationRate so I stuck with that.
ServerDate.amortizationRate = 1000000; // ms
